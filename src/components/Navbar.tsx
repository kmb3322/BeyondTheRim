        ...
        <Flex gap={4} align="center">
          {headerType === 'header1' ? (
            ...
            user && (
              <>
                <Link to="/upload">
                  <Button colorScheme="#f33c3c" ml={6} width={20} height={8} borderRadius={5} fontSize={14} borderColor="#f33c3c" color="#f33c3c" fontFamily="Noto Sans KR" variant="outline" zIndex={9999}
                 _hover={{
                  color:"black",
                ...
                <Button colorScheme="#f33c3c" width={20} height={8} borderRadius={5} fontSize={14} onClick={handleLogout} borderColor="#f33c3c" color="#f33c3c" fontFamily="Noto Sans KR" variant="outline" zIndex={9999}
                 _hover={{
                  color:"black",
                   bg: "#f33c3c", // 커서 올렸을 때의 배경색
                   transform: "scale(1.02)", // 약간 확대 효과
